...
public class ChatController {
    ...
    public ResponseEntity<Chat> addMediaMessage(@RequestParam int chatId,
            @RequestParam MultipartFile image, @RequestParam String fileType, @RequestParam String userId)
            throws ChatNotFoundException, Exception {
        Message message = new Message();
        message.setSenderEmail(userId);
    ...
    @DeleteMapping("/deleteChats/{chatId}")
    public void deleteChats(@PathVariable int chatId) {
        System.out.println("Hello");
        chatService.deleteChats(chatId);
